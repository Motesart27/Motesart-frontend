      ...
      <div style={{ borderBottom:'1px solid #1f2937', position:'sticky', top:0, background:'rgba(17,24,39,0.95)', backdropFilter:'blur(12px)', zIndex:10, padding:'12px 16px', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize:10, color:'#9ca3af' }}>Student Dashboard</div>
          </div>
        </div>
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          ...
          <button onClick={() => navigate('/tami')} style={{ display:'flex', alignItems:'center', gap:6, padding:'5px 12px 5px 5px', background:'linear-gradient(135deg,rgba(232,75,138,0.2),rgba(249,115,22,0.2))', border:'1px solid rgba(249,115,22,0.5)', borderRadius:20, cursor:'pointer' }}>
            ...
            <span style={{ fontSize:11, fontWeight:700, color:'#fb923c', whiteSpace:'nowrap' }}>TAMi Dash</span>
          </button>
          ...
          <button onClick={() => navigate('/settings')} style={{ padding:'6px 12px', background:'none', border:'1px solid rgba(255,255,255,.15)', borderRadius:8, fontSize:14, cursor:'pointer', color:'#9ca3af' }} title="Settings">⚙️</button>
        </div>
      </div>
