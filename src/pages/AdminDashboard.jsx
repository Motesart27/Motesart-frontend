...
import motesartAvatar from './assets/motesart-avatar.png';
...
function TopNav() {
  ...
  const tabs = [
    ...
    { label: 'TAMi', isTami: true, route: '/tami' },
  ...
  return (
    <div className="profile-header">
      ...
      <div className="tami-pill">
        <div style={{ width: 34, height: 34, borderRadius: '50%', background: 'linear-gradient(135deg, #e84b8a, #a855f7)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, border: '2px solid rgba(210,170,80,0.5)' }}>
          {'\uD83D\uDCAC'}
        </div>
