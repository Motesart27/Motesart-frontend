    ...
    <div style={S.body}>
      ...
      <div style={S.logoWrapper}>
        ...
        <div style={S.logoCircle}>
          <video src="/logo-anim.mp4" autoPlay loop muted playsInline style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 47%' }} />
        </div>
      </div>
...
const S = {
  ...
  logoWrapper: { position: 'relative', marginBottom: 16, width: 190, height: 190, display: 'flex', alignItems: 'center', justifyContent: 'center' },
  laserRing1: { position: 'absolute', top: '50%', left: '50%', width: 165, height: 165, borderRadius: '50%', border: '2px solid transparent', borderTopColor: '#d946ef', borderRightColor: '#a855f7', animation: 'laserSpin 3s linear infinite', filter: 'drop-shadow(0 0 8px rgba(217,70,239,.6)) drop-shadow(0 0 20px rgba(168,85,247,.3))' },
  laserRing2: { position: 'absolute', top: '50%', left: '50%', width: 175, height: 175, borderRadius: '50%', border: '1px solid transparent', borderBottomColor: '#06b6d4', borderLeftColor: '#8b5cf6', animation: 'laserSpin 5s linear infinite reverse', filter: 'drop-shadow(0 0 6px rgba(6,182,212,.4)) drop-shadow(0 0 15px rgba(139,92,246,.2))' },
  ...
  logoCircle: { position: 'relative', width: 150, height: 150, borderRadius: '50%', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 40px rgba(168,85,247,.3),0 0 80px rgba(168,85,247,.15)', overflow: 'hidden', zIndex: 2 },
