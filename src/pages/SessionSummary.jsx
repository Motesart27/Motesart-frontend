  ...
  return (
    <div className="ss-page"><style>{css}</style>
      ...
      <div className="ss-main">
        ...
        <div className="ss-section"><div className="ss-lb-pos"><div style={{fontSize:13,color:'#c4b5fd'}}>Your Current Position</div><div style={{fontSize:40,fontWeight:700,marginTop:4}}>#4</div><div style={{fontSize:11,color:'#9ca3af',marginTop:4}}>on T.A.M.i Leaderboard</div></div></div>
        <div className="ss-section"><div className="ss-mini">
          <div style={{display:'flex',alignItems:'center',gap:8,fontWeight:600,marginBottom:12}}>🏆 T.A.M.i Leaders</div>
          {LEADERS.map((l,i)=>(
