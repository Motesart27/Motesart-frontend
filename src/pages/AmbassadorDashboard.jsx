...
export const IntelligenceOverlay = ({ isOpen, onClose, onTamiClick }) => {
  const keywords = [
    { text: '🎵 music journey', color: 'rgba(167,139,250,0.15)', textColor: '#a78bfa' },
  ...
  const audienceMatch = [
    ...
    { label: 'Teens (13–18)', width: '90%', color: '#a78bfa', val: '90%' },
    { label: 'Young Adults (18–25)', width: '85%', color: '#3b82f6', val: '85%' },
    { label: 'Kids (6–12)', width: '72%', color: '#f97316', val: '72%' },
  ...
  const kitButtons = [
    ...
    { label: '🖼️ Download Referral Graphic', onClick: () => console.log('Download Referral Graphic') },
    ...
    <div className={`intel-overlay ${isOpen ? 'open' : ''}`}>
      ...
      <div className="intel-body">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', marginBottom: '16px' }}>
          ...
          <div className="icard">
            <div className="icard-title">
              🎙️ Voice & Brand Mimic <span className="ipill ip-pk">Ready</span>
            </div>
