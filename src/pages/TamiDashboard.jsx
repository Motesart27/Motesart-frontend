      ...
      <div style={{ borderBottom:'1px solid #1f2937', position:'sticky', top:0, background:'rgba(17,24,39,0.95)', backdropFilter:'blur(12px)', zIndex:10, padding:'12px 16px', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        <div style={{ display:'flex', alignItems:'center', gap:12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize:11, color:'#fb923c', marginTop:2 }}>T.A.M.i Dashboard · Teaching Assistant for Musical Intelligence</div>
          </div>
        </div>
        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
          ...
          <button onClick={() => navigate('/student')} style={{ padding:'6px 14px', background:'none', border:'1px solid rgba(255,255,255,.15)', borderRadius:8, fontSize:12, cursor:'pointer', color:'#9ca3af' }}>← Back to Dashboard</button>
          <button onClick={() => navigate('/settings')} style={{ padding:'6px 10px', background:'none', border:'1px solid rgba(255,255,255,.15)', borderRadius:8, fontSize:14, cursor:'pointer', color:'#9ca3af' }}>⚙️</button>
        </div>
      </div>
          ...
          <TCard title="WYL Profile · Way You Learn">
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
              ...
              <div style={{ background:'rgba(249,115,22,0.08)', border:'1px solid rgba(249,115,22,0.2)', borderRadius:8, padding:10 }}>
                <div style={{ fontSize:11, fontWeight:700, color:'#fb923c', marginBottom:8 }}>How T.A.M.i Adapts</div>
          ...
          <div style={{ background:'linear-gradient(135deg,rgba(232,75,138,0.12),rgba(249,115,22,0.12))', border:'1px solid rgba(232,75,138,0.25)', borderRadius:12, overflow:'hidden' }}>
            ...
            <div style={{ padding:16 }}>
              ...
              <div style={{ padding:'12px 14px', background:'rgba(0,0,0,0.2)', borderRadius:8, borderLeft:'3px solid #fb923c' }}>
                <div style={{ fontSize:10, color:'#fb923c', fontWeight:700, marginBottom:6 }}>T.A.M.i says</div>
